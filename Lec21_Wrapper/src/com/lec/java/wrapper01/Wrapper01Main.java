...
public class Wrapper01Main {
	...
	public static void main(String[] args) {
		...
		//Wrapper 클래스는 마치 primitive 타입처럼 동작
		...
		// 4. literal 상수로 생성
		System.out.println();
		Integer num5 = 123; //기존에 있었던 것을 리턴
		...
		// 6. 산술 연산 가능
		num6 *= 2; //Wrapper 의 연산결과는 새로운 Wrapper 생성
		System.out.println(num6);
		
		if(num6 == num5) {
			System.out.println("같은 참조");
		} else { 
			System.out.println("다른 참조"); //다르다 Wrapper클래스는 immutable 하다.
		}
