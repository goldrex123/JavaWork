...
public class Collection06Main {
	...
	public static void main(String[] args) {
		...
		set.add(1);
		set.add(2);
		System.out.println(set.add(100)); //false 값 출력 - 리턴이 boolean이다.
		...
		while(itr.hasNext()) {
			System.out.println(itr.next()); // 출력결과, 저장순서와는 관계 없다.
		}
		...
		set.remove(2); // 데이터 '2'를 삭제
		System.out.println(set.remove(2));  //예외x false리턴
		System.out.println();
...
//		itr.next(); // exception 발생 (NoSuchElementException)
