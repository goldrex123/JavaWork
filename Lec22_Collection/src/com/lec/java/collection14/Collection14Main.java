...
public class Collection14Main {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(list1); // list1의 toString 결과값
		...
		// "2018-08-16" --> Date 객체
		list2.add(new SimpleDateFormat("yyyy-MM-dd").parse("2018-08-15"));
		...
		Collections.sort(list3); // comparable 구현 후 에러 삭제
		// Comparable<> 구현 후 실행
		...
		List<String> arrList = Arrays.asList(arr); //배열을 리스트로 변환 (List<>의 toArray()와 반대)
...
//Student를 이름으로 정렬해줄 수 있는 Comparator<> 제공
