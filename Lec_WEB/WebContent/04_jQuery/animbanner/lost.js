(function(){
    ...
    (function loopCloud(){
        $cloud1.animate({'left' : '-720px'}, 10000)
            .animate({left : '0px'}, 0)

        $cloud2.animate({'left' : '0px'}, 10000)
    ...
    //     loopBoat();
    //     $questionMark.delay(500).animate({opacity:1},500, function(){
    ...
    // .then(function(){
    //     loopBoat();
    //     return $.when($questionMark.delay(500).animate({opacity:1},500));
    // })
    // .then(function(){
    ...
    // 방법3 : 단일 애니메이션 연속인 경우 promise() 만으로 가능하다
    ...
    function loopBoat(){
        ...
        $boat.animate({bottom : '25px'},500, loopBoat)
    }
