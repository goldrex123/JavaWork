...
console.log(str1.lastIndexOf("locate")) // 21번쨰 발견

console.log(str1.indexOf("John"))  // 못 찾으면 -1 리턴
console.log(str1.indexOf("locate", 10)) // 10번째 부터 검색 시작
...
console.log(str1.substring(7, 13)) //slice와 유사하나 음수 인덱싱 지원 안함 
...
console.log(str1.replace("JAPAN", "Korea")); //대소문자 일치해야함 
console.log(str1.replace(/JAPAN/i, "Korea")); //정규표현식 (대소문자 구분 없이 치환 /i/)
