...
for (i = 0; i < cars.length; i++) { // 위의 경우보다 좋은 성능
    console.log(cars[i])
}

console.log()
// for ~ in : 객체에 대해 사용, property
...
console.log(fruits.toString()) // 현재 fruits 상태
console.log(fruits.pop());
console.log(fruits.toString());
console.log(fruits.shift());
console.log(fruits.toString());
console.log(fruits.unshift('Grape')); //배열 앞에 추가 ,새로 추가된 length를 리턴한다 
console.log(fruits.toString());
...
var arr = [10, 3.14, 'hello', null, undefined, function (a, b) {
    return a + b;
}]
