...
public class RegExp03Main {
	...
	public static void main(String[] args) {
		...
		regex = "[abc]"; // a or b or c 중에 한 문자에 매칭 
		arrInput = new String[] {
				"able",
				"bible",
				"cable",
		...
		regex = "[abc]+";
		regex = "[a-z]+"; //a부터 z까지 문자 1개 이상  --> 소문자로 구성된 문자 
		arrInput = new String[] {
				"abc100",
				"abcDefGHIUJ-KLM123opQrstuz"
			};
		regex = "[a-zA-z]+"; //영어 문자로 구성딘 문자
		regex = "[a-zA-z0-9]+";
		regex = "[a-zA-z0-9-]+";
		arrInput = new String[] {
				"23",
	...
	/*	
		...
		regex = "ab{2}"; // a로 시작하여 b가 2개 매칭
		arrInput = new String[] {
				"abb",
				"abbb",
				"abbbabbbbbbbbabaabab",
		};
		regex = "ab{2,}"; //b의 개수 2개 이상
		regex = "ab{3,5}"; // b의 개수가 3개부터 5개까지
		
		//─────────────────────────────────────────
		title = " () : ()안에 있는 글자들을 그룹화 ";
		regex = "a(bc)*"; // a로 시작하고 (bc)가 없거나 하나이상 
		arrInput = new String[] {
				"abc",
				"abcbcbbc",
				"abcabcabc",
		...
		arrInput = new String[] {
				...
				"ab",
				"xyz",
				"abccbbcccbbaaabcbccbbaacbaaaccc"
		};
		regex = "(a|b)+";
		...
		regex = "regex = \"(?i)[a-zA-Z]{2}[-]{1}^[1-9][0-9]{3}[-]{1}^[1-9][0-9]{2}[-]{1}(?i)[a-zA-Z]{3}\";"; // TODO
//		regex = "[.]+";
		arrInput = new String[] {
				"Ab-7890-786-zuy"
		};
