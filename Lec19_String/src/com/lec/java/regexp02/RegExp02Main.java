...
public class RegExp02Main {
	...
	public static void main(String[] args) {
		...
		while (matcher.find()) {
			...
			System.out.println("\t group(0) : " + matcher.group(0) + "{" + matcher.start(0) + "~" + matcher.end(0) + "}"); // 0번 그룹은 전체 문자열
			System.out.println("\t group(1) : " + matcher.group(1) + "{" + matcher.start(1) + "~" + matcher.end(1) + "}"); // 1번 그룹은 첫 번째 괄호
