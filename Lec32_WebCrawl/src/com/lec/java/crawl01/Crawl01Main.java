 ...
 * 3. 프로젝트 우클릭 - configure Build Path - Library탭  - Add Jars(혹은 라이브러리 추가) 선택 - 추가할 라이브러리 선택 
 */
...
public class Crawl01Main {
	...
	public static void main(String[] args) throws IOException {
		...
		response = Jsoup.connect(url).execute(); // GET 방식 request는 다음과 같이 해도 된다
...
//		System.out.println(outerHtml.substring(0,200) + "...");
		...
		Elements newsElements = doc.select("#news_cast li.ca_item"); //검색된 Element 들이 담겨 있는 Elements를 리턴
		// 복수개 목록 크롤링 할시, 내가 원하는 개수만큼 크롤링 되었는지 우선 확인해 보자
