...
public class Crawl17Main {
	...
	private static final String WEB_DRIVER_PATH = "C:/JavaApp/download/chromedriver.exe";
...
//		System.out.println(element.getSize());
		element.sendKeys("너의아이디?"); //키보드 타이핑 입력
		
		//패스워드 입력
		element = driver.findElement(By.id("pw"));
		element.sendKeys("너의비번은?");
	...
	public void faceBookLogin() {
		...
		element.sendKeys("늬아이디?");
		
		//패스워드 입력
		element = driver.findElement(By.id("pass"));
		element.sendKeys("니비번?");
